...
import com.csst.services.coreService.MyX509TrustManager;
...
public class WeixinUtil {
     ...
     * @throws Exception 
     */  
    public static int uploadMedia(File file,String type, String accessToken) throws Exception {  
    	int result = 0;  
    	...
    	String datas = w.getJsonData(url);
    	JSONObject jsonData = JSONObject.fromObject(datas); 
    	String mediaId = jsonData.getString("media_id").toString();
