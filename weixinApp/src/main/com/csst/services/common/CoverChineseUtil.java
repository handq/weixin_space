...
public class CoverChineseUtil {  
    ...
    private static CoverChineseUtil chineseSpelling = new CoverChineseUtil();  
    public static CoverChineseUtil getInstance() {  
    ...
    public static String trans2PinYin(String str) {  
        return CoverChineseUtil.getInstance().convertAll(str);  
    }  
