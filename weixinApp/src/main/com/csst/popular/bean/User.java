...
public class User extends BaseResult{
	...
	public void setSubscribe_time(Integer subscribeTime) {
		...
		this.subscibeTime = format.format(new Date(subscribeTime*1000L));
	}
	...
	public String getSubscibeTime() {
		return subscibeTime;
	}

	public void setSubscibeTime(String subscibeTime) {
