...
import com.csst.popular.bean.pay.PayJsRequest;
import com.csst.popular.bean.pay.PayNativeReply;
import com.csst.popular.bean.pay.PayNativeRequest;
import com.csst.popular.bean.pay.PayPackage;
...
public class PayUtil {
	...
	public static String generatePayNativeRequestURL(
		...
		return "com.csst://wxpay/bizpayurl?" + MapUtil.mapJoin(map, false, false);
	}
