...
<head>
<body >
		<div style="font-size: 14px;font-weight: bold;margin-top: 10px;" align="center">自定义菜单增加</div>
		...
		<table width="100%" border="0"  cellpadding="0" cellspacing="0"
			...
			<td align="center" valign="middle" colspan="3" width="50%">
				<s:textfield name="userMenu.usermenuName"  value="" required="true" style="width: 100%" requiredposition="left" />
			</td>
			...
			<td align="center" valign="middle" colspan="3" width="60%">
				<s:textfield name="userMenu.usermenuCode" value=""  required="true" style="width: 100%" requiredposition="left" />
			</td>
			</tr>
			<tr onMouseOut="this.style.background='#eeeeee'"
			...
			<td align="center" valign="middle" colspan="3" width="60%">
				<select name="userMenu.usermenuLeve"  style="width: 100%;border:0px;">
					<option  value="${userMenu.usermenuLeve==null?1:2}">${userMenu.usermenuLeve==null?"一级":"二级"}</option>
				</select>
			</td>
			</tr>
			<tr onMouseOut="this.style.background='#ffffff'"
			...
			<td align="center" valign="middle" colspan="3" width="60%">
				<select name="userMenu.fkUmid" style="width: 100%;border:0px;">
						<option value="${userMenu.id==null?"0":userMenu.id}">${userMenu.id==null?"主菜单":userMenu.usermenuName}</option>
				</select>
			</td>
			</tr>
			<tr onMouseOut="this.style.background='#ffffff'"
			...
			<td align="center" valign="middle" colspan="3" width="60%">
				<s:textfield name="userMenu.usermenuNo"  value="" required="true" style="width: 100%" requiredposition="left" />
			</td>
			</tr>
			<tr onMouseOut="this.style.background='#eeeeee'"
				onMouseOver="this.style.background='#F4E088'" bgcolor="#eeeeee">
			...
			<td align="center" valign="middle" colspan="3" width="60%">
				<s:textfield name="userMenu.usermenuLink"  value="" required="true" style="width: 100%" requiredposition="left" />
			</td>
			</tr>
		</table>
